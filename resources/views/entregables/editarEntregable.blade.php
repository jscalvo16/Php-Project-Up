                ...
                <div class="main-content">
                    <div class="page-header">
                        ...
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                ...
                                <a class="breadcrumb-item" href="#">Ficha {{ $ficha->NumbFich }}</a>
                                <a class="breadcrumb-item" href="gestionEntregables.html">Gestión de entregables</a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            <form action="{{ url('entregable'.$entre->IdEntre) }}" method="POST">
                                @method('PUT')
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="tituloEntre" id="tituloEntre" placeholder="Título del entregable" value="{{ $entre->TituEntre }}">
                                    </div>
                                ...
                                <input type="hidden" value="{{ $ficha->IdFicha }}"  name="ficha" id="ficha">
