                    ...
                    <div class="page-header">
                        ...
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                ...
                                <a class="breadcrumb-item" href="usuarios.html">Usuarios</a>
                        ...
                        <div class="card-body">
                            ...
                            <form action="#" method="POST">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="numerodoc"><sup class="obligatorio">*</sup>Número de identificación</label>
                                        <input type="text" class="form-control" name="numerodoc" id="numerodoc" placeholder="Número de identificación">
                                    </div>

                                    <!-- Input Fecha de nacimiento -->
                                    <div class="form-group col-md-6">
                                        <label for="fechaNacimiento"><sup class="obligatorio">*</sup>Fecha de nacimiento</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email" placeholder="Correo misena">
                                    </div>
