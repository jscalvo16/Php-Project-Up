        ...
        <div class="cards contenedor">
            <div class="login-content">
                <form action="{{ url('enviar-link') }}" method="POST">
                    @csrf
                    <p style="text-align: center"><img class="loginImg"
                            src=" {{ asset('assets/img/Logo_login.png') }} " alt="Logo PROJECTUP"></p>
                    <br>
                    <h3 class="title">Podemos ayudarte a restablecer tu contraseña.</h3>
                    <br>
